# -*- coding: utf-8 -*-
#
# montblanc documentation build configuration file, created by
...
from montblanc._version import get_versions
...
htmlhelp_basename = 'montblancdoc'
...
intersphinx_mapping = {'hypercube': ('https://hypercube.readthedocs.io/en/latest', None)}
