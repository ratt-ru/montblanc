...
#define stamp_sersic_chi_squared_gradient_fn(ft, ct, uvwt, apply_weights, symbol) \
__global__ void \
sersic_chi_squared_gradient_ ## symbol ## chi_ ## ft( \
    uvwt * uvw, \
    ft * sersic_shape, \
    ft * frequency, \
    int * ant_pairs, \
...
stamp_sersic_chi_squared_gradient_fn(float, float2, float3, false, u)
stamp_sersic_chi_squared_gradient_fn(float, float2, float3, true, w)
stamp_sersic_chi_squared_gradient_fn(double, double2, double3, false, u)
stamp_sersic_chi_squared_gradient_fn(double, double2, double3, true, w)
} // extern "C" {
""")
...
class SersicChiSquaredGradient(Node):
    ...
    def initialise(self, solver, stream=None):
        ...
        kname = 'sersic_chi_squared_gradient_' + \
