...
class TestSolver(unittest.TestCase):
    ...
    def test_register_array_basic(self):
    	""" """
    	slvr = BaseSolver(na=3,nchan=32,ntime=10,npsrc=10,ngsrc=10)
    ...
    def test_register_array_store_cpu(self):
        ...
        slvr = BaseSolver(na=3,nchan=32,ntime=10,npsrc=10,ngsrc=10, store_cpu=True)
    ...
    def test_register_array_create_existing(self):
        ...
        slvr = BaseSolver(na=14,nchan=32,ntime=10,npsrc=10,ngsrc=10)
    ...
    def test_auto_correlation(self):
        ...
        autocor = True
        slvr = BaseSolver(na=na,ntime=5,nchan=16,npsrc=2,ngsrc=2,auto_correlations=autocor)
    ...
    def test_viable_timesteps(self):
        ...
        slvr = BaseSolver(na=14,ntime=ntime,nchan=nchan,npsrc=npsrc,ngsrc=ngsrc)
