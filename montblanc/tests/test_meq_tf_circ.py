...
msfile = os.path.join(data_dir, 'vla_test.ms')
...
beam_file_prefix = 'JVLA-L-centred-'
base_beam_file = os.path.join(beam_dir, beam_file_prefix)
beam_file_pattern = ''.join((base_beam_file, '$(corr)_$(reim).fits'))
l_axis = '-X'

print beam_file_pattern
